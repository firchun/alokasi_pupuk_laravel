...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pengajuan_pupuk_petani', function (Blueprint $table) {
            $table->id();
            $table->foreignId('id_poktan')->constrained('users')->onDelete('cascade');
            $table->foreignId('id_anggota')->constrained('kelompok_tani')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('pengajuan_pupuk');
    }
};
