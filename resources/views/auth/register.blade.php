            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="app-brand justify-content-center">
                    <a href="{{ url('/') }}" class="app-brand-link gap-2">
                        ...
                        <span class="app-brand-text demo text-success fw-bolder">{{ env('APP_NAME') ?? 'LARAVEL' }}</span>
                    </a>
                </div>
                <!-- /Logo -->
                <h4 class="mb-2">Welcome 👋</h4>
                <p class="mb-4">Silahkan mendaftar terlebih dahulu untuk menjadi distributor pupuk</p>
